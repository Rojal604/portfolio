...
export default function Projects() {
  ...
  return (
    <section id="projects" className="relative py-20 sm:py-28 lg:py-32 px-4 sm:px-6 overflow-hidden bg-background">
      {/* Background Elements */}
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 sm:mb-16 gap-6">
            ...
            <div className="flex md:hidden items-center gap-3 w-full justify-center">
              <button
                ...
                className="p-2.5 sm:p-3 rounded-full bg-primary/10 hover:bg-primary/20 border border-primary/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed min-h-[44px] min-w-[44px]"
                aria-label="Previous page"
              >
                <ChevronLeft className="w-5 h-5 text-primary" />
              </button>
              <span className="text-sm font-mono text-primary/50 min-w-[60px] text-center">
            ...
            {currentProjects.map((project, index) => (
              <RevealOnScroll key={project.title} delay={index * 0.1}>
                <div onClick={() => setSelectedProject(startIndex + index)} className="cursor-pointer h-full">
                  <GlowCard className="h-full" enableTilt>
                    <div className="relative h-full flex flex-col">
                      ...
                      <div className="aspect-[4/3] overflow-hidden relative">
                        ...
                        <div className="absolute top-4 right-4 z-20 w-10 h-10 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center border border-white/20 text-white opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                ...
                <div className="p-6 sm:p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-auto">
                    ...
                    <a
                      ...
                      className="px-5 sm:px-6 py-3 sm:py-4 bg-secondary text-secondary-foreground rounded-xl font-bold hover:bg-secondary/80 transition-all flex items-center justify-center gap-2 min-h-[48px] text-sm sm:text-base"
                    >
